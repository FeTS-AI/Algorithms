...
class GANDLFData(object):
    ...
    def setup_for_train_val(self):
        ...
        self.pickled_lost_training_path = os.path.join(self.split_instance_dirpath, 'lost_train.pkl')
    ...
    def utilize_existing_split(self):
        ...
        if (these_missing_train != set([])) or (these_missing_val != set([])):
            ...
            if these_missing_train != set([]):
                ...
                dump_pickle(list(these_missing_train), self.pickled_lost_train_path)
            ...
            if these_missing_val != set([]):
                ...
                dump_pickle(list(these_missing_val), self.pickled_lost_val_path)
                if not allow_disk_data_loss_after_split_creation:
            ...
            if allow_disk_data_loss_after_split_creation:
        ...
        if self.allow_new_data_into_preexisting_split:
            ...
            missing_train = set(load_pickle(self.pickled_lost_training_path))
            missing_val = set(load_pickle(self.pickled_lost_val_path))

            # we know how to place these subdirs (may be empty)
            add_train_subdirs = list(disk_subdir.intersection(missing_train)) 
            ...
            new_subdirs_to_split = list(disk_subdirs - split_train_subdirs - split_val_subdirs - add_train_subdirpaths - add_val_subdirpaths)
    ...
    def subdirpaths_to_subdirs(self, subdirpaths):
        return [os.path.split(subdir_path)[1] for subdirpath in subdirpaths]
    ...
    def compute_fresh_split(self):
        ...
        self.train_subdirs = subdirs[:split_idx]
        self.val_subdirs = subdirs[split_idx:]
